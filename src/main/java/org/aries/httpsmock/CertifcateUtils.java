...
public class CertifcateUtils {  
    public static byte[] readCertifacates() throws Exception{  
        ...
        InputStream in=new FileInputStream("https.crt");
    ...
    public static byte[] readPrivateKey() throws  Exception{  
        ...
        InputStream in=new FileInputStream("https.keystore");
        store.load(in,"quanquan".toCharArray());
        PrivateKey pk=(PrivateKey)store.getKey("quanquan","quanquan".toCharArray());
